 ...
 * @author Ghostemane
 */
public class PaginaPrincipalContactos extends javax.swing.JFrame {

    /**
     * Creates new form frmPrincipal
     */
    public Hashtable<String,Persona> contacto = new Hashtable();
    public PaginaPrincipalContactos() {
        initComponents();
        deserializar();
    }
    ...
    private void initComponents() {
        ...
        btnCrearContacto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/cuc/imagenes/nuevo.png"))); // NOI18N
    ...
    private void btnCrearContactoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearContactoActionPerformed
        // TODO add your handling code here:
        PaginaContactos frmcontacto = new PaginaContactos();
    ...
    private void frmListarContactoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_frmListarContactoActionPerformed
        PaginaListarContactos listarContactos = new PaginaListarContactos();
        Dimension escritorioSize = this.PanelEscriorio.getSize();
        Dimension listarContactoSize = listarContactos.getSize();
        listarContactos.setLocation((escritorioSize.width -listarContactoSize.width)/2, (escritorioSize.height -listarContactoSize.height)/2);    
       
        this.PanelEscriorio.add(listarContactos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaginaPrincipalContactos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaginaPrincipalContactos().setVisible(true);
            }
        });
    }
    private void deserializar(){
        ...
        try {
            ...
            br = new BufferedReader(new FileReader("datos.json"));
             contacto = gson.fromJson(br, NuevoContacto.class);
